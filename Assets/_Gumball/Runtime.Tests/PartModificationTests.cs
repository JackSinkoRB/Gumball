...
namespace Gumball.Runtime.Tests
{
    public class PartModificationTests : IPrebuildSetup, IPostBuildCleanup
    {
        ...
        public IEnumerator CorePartInstalling()
        {
            ...
            CorePartManager.InstallPartOnCurrentCar(CorePart.PartType.ENGINE, TestManager.Instance.CorePartA, carIndexToUse);
        ...
        public IEnumerator CorePartSwitching()
        {
            ...
            //apply the part to the car
            CorePartManager.InstallPartOnCurrentCar(CorePart.PartType.ENGINE, TestManager.Instance.CorePartB, carIndexToUse);
