	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode41 = tex2D( _Mask_01, uv_Mask_01 );
				float4 lerpResult35 = lerp( tex2D( _MainTex, uv_MainTex ) , _Rollcage_Color , tex2DNode41.r);
				...
				float4 tex2DNode49 = tex2D( _Mask_02, uv_Mask_02 );
				...
				float4 tex2DNode56 = tex2D( _Mask_03, uv_Mask_03 );
				...
				float4 tex2DNode63 = tex2D( _Mask_04, uv_Mask_04 );
				...
				float4 tex2DNode70 = tex2D( _Mask_05, uv_Mask_05 );
				...
				float4 tex2DNode77 = tex2D( _Mask_06, uv_Mask_06 );
				...
				float4 tex2DNode81 = tex2D( _Mask_07, uv_Mask_07 );
				...
				float4 tex2DNode86 = tex2D( _Mask_08, uv_Mask_08 );
				...
				float4 tex2DNode202 = tex2D( _Mask_09, uv_Mask_09 );
				...
				float4 tex2DNode32 = tex2D( _Gloss_Metal, uv_Gloss_Metal );
				float lerpResult105 = lerp( tex2DNode32.g , _Rollcage_Metal , tex2DNode41.r);
				float lerpResult106 = lerp( lerpResult105 , _Tub_Metal , tex2DNode41.g);
				float lerpResult107 = lerp( lerpResult106 , _EngineBay_Metal , tex2DNode41.b);
				float lerpResult113 = lerp( lerpResult107 , _Wheel_01_Metal , tex2DNode49.r);
				float lerpResult114 = lerp( lerpResult113 , _Wheel_02_Metal , tex2DNode49.g);
				float lerpResult115 = lerp( lerpResult114 , _Wheel_03_Metal , tex2DNode49.b);
				float lerpResult134 = lerp( lerpResult115 , _Seat_01_Metal , tex2DNode56.r);
				float lerpResult127 = lerp( lerpResult134 , _Seat_02_Metal , tex2DNode56.g);
				float lerpResult132 = lerp( lerpResult127 , _Seat_03_Metal , tex2DNode56.b);
				float lerpResult139 = lerp( lerpResult132 , _E_Brake_01_Metal , tex2DNode63.r);
				float lerpResult135 = lerp( lerpResult139 , _E_Brake_02_Metal , tex2DNode63.g);
				float lerpResult137 = lerp( lerpResult135 , _Shifter_01_Metal , tex2DNode63.b);
				float lerpResult152 = lerp( lerpResult137 , _Shifter_02_Metal , tex2DNode70.r);
				float lerpResult149 = lerp( lerpResult152 , _Tacho_01_Metal , tex2DNode70.g);
				float lerpResult154 = lerp( lerpResult149 , _Tacho_02_Metal , tex2DNode70.b);
				float lerpResult166 = lerp( lerpResult154 , _Tacho_03_Metal , tex2DNode77.r);
				float lerpResult160 = lerp( lerpResult166 , _Cosmetic_01_Metal , tex2DNode77.g);
				float lerpResult164 = lerp( lerpResult160 , _Cosmetic_02_Metal , tex2DNode77.b);
				float lerpResult176 = lerp( lerpResult164 , _Cosmetic_03_Metal , tex2DNode81.r);
				float lerpResult171 = lerp( lerpResult176 , _Cosmetic_04_Metal , tex2DNode81.g);
				float lerpResult175 = lerp( lerpResult171 , _Cosmetic_05_Metal , tex2DNode81.b);
				float lerpResult193 = lerp( lerpResult175 , _Alloy_01_Metal , tex2DNode86.r);
				float lerpResult191 = lerp( lerpResult193 , _Alloy_02_Metal , tex2DNode86.g);
				float lerpResult189 = lerp( lerpResult191 , _Alloy_03_Metal , tex2DNode86.b);
				float lerpResult203 = lerp( lerpResult189 , _Cosmetic_06_Metal , tex2DNode202.r);
				float lerpResult206 = lerp( lerpResult203 , _Cosmetic_07_Metal , tex2DNode202.g);
				float lerpResult211 = lerp( lerpResult206 , _Alloy_04_Metal , tex2DNode202.b);
				
				float lerpResult97 = lerp( tex2DNode32.r , _Rollcage_Gloss , tex2DNode41.r);
				float lerpResult100 = lerp( lerpResult97 , _Tub_Gloss , tex2DNode41.g);
				float lerpResult101 = lerp( lerpResult100 , _EngineBay_Gloss , tex2DNode41.b);
				float lerpResult111 = lerp( lerpResult101 , _Wheel_01_Gloss , tex2DNode49.r);
				float lerpResult112 = lerp( lerpResult111 , _Wheel_02_Gloss , tex2DNode49.g);
				float lerpResult116 = lerp( lerpResult112 , _Wheel_03_Gloss , tex2DNode49.b);
				float lerpResult133 = lerp( lerpResult116 , _Seat_01_Gloss , tex2DNode56.r);
				float lerpResult128 = lerp( lerpResult133 , _Seat_02_Gloss , tex2DNode56.g);
				float lerpResult126 = lerp( lerpResult128 , _Seat_03_Gloss , tex2DNode56.b);
				float lerpResult138 = lerp( lerpResult126 , _E_Brake_01_Gloss , tex2DNode63.r);
				float lerpResult136 = lerp( lerpResult138 , _E_Brake_02_Gloss , tex2DNode63.g);
				float lerpResult146 = lerp( lerpResult136 , _Shifter_01_Gloss , tex2DNode63.b);
				float lerpResult147 = lerp( lerpResult146 , _Shifter_02_Gloss , tex2DNode70.r);
				float lerpResult151 = lerp( lerpResult147 , _Tacho_01_Gloss , tex2DNode70.g);
				float lerpResult153 = lerp( lerpResult151 , _Tacho_02_Gloss , tex2DNode70.b);
				float lerpResult161 = lerp( lerpResult153 , _Tacho_03_Gloss , tex2DNode77.r);
				float lerpResult162 = lerp( lerpResult161 , _Cosmetic_01_Gloss , tex2DNode77.g);
				float lerpResult163 = lerp( lerpResult162 , _Cosmetic_02_Gloss , tex2DNode77.b);
				float lerpResult172 = lerp( lerpResult163 , _Cosmetic_03_Gloss , tex2DNode81.r);
				float lerpResult173 = lerp( lerpResult172 , _Cosmetic_04_Gloss , tex2DNode81.g);
				float lerpResult174 = lerp( lerpResult173 , _Cosmetic_05_Gloss , tex2DNode81.b);
				float lerpResult188 = lerp( lerpResult174 , _Alloy_01_Gloss , tex2DNode86.r);
				float lerpResult190 = lerp( lerpResult188 , _Alloy_02_Gloss , tex2DNode86.g);
				float lerpResult192 = lerp( lerpResult190 , _Alloy_03_Gloss , tex2DNode86.b);
				float lerpResult204 = lerp( lerpResult192 , _Cosmetic_06_Gloss , tex2DNode202.r);
				float lerpResult209 = lerp( lerpResult204 , _Cosmetic_07_Gloss , tex2DNode202.g);
				float lerpResult210 = lerp( lerpResult209 , _Alloy_04_Gloss , tex2DNode202.b);
...
ASEEND*/
//CHKSM=D08EB5E93B221C76C3D8AC153FB6D4DC8BCF213E