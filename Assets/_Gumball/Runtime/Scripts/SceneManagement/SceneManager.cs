...
namespace Gumball
{
    public class SceneManager : PersistentSingleton<SceneManager>
    {
        ...
        public const string WarehouseSceneName = "Hanger";
        ...
        public const string MainSceneAddress = "Scenes/" + MainSceneName + ".unity";
        ...
        public const string WarehouseSceneAddress = "Scenes/" + WarehouseSceneName + ".unity";
