...
namespace Gumball
{
    public class ScrollIcon : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public void OnClick()
        {
            ...
            {
                scrollBelongsTo.SnapIconToMagnet(this);
            }
        }
        ...
        {
            Button = gameObject.GetComponent<Button>(true);
        ...
        public void TweenToPos(Vector2 pos, float time)
        {
            ...
            CurrentTween = RectTransform.DOAnchorPos(pos, time).OnComplete(() =>
                CoroutineHelper.Instance.PerformAtEndOfFrame(() => CurrentTween = null)); //if ended before the frame, the final frame update won't apply effects
        }
