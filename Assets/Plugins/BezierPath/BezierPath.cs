...
*/
    public class BezierPath : MonoBehaviour
    {
        ...
        {
            get { return cachedPoints.Count > 0 ? cachedPoints[cachedPoints.Count - 1].distance : 0; }
        }

        public BezierPathPoint finalPoint
        {
            get { return cachedPoints[cachedPoints.Count - 1]; }
        }
